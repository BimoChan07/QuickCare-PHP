<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="dashboard.php" class="navbar-brand">
      <h3 style="font-family:'Trebuchet MS';">&nbsp;&nbsp;&nbsp;&nbsp;QuickCare</h3>
      <!-- <img src="../assets/images/logos/quickcare.png" width="35%" class="img-fluid"> -->
    </a>
  </div><!-- .navbar-header -->
    ...
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      ...
      <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
        ...
        <li class="dropdown">
          ...
          <div class="media-group dropdown-menu">
            <?php
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <small class="media-meta">
                      <?php echo $row->AppointmentNumber; ?> at (
