...
if (strlen($_SESSION['damsid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT id FROM doctor WHERE id=:eid and password=:cpassword";
    ...
    if ($query->rowCount() > 0) {
      $con = "update doctor set password=:newpassword where id=:eid";
      $chngpwd1 = $dbh->prepare($con);
      $chngpwd1->bindParam(':eid', $eid, PDO::PARAM_STR);
      $chngpwd1->bindParam(':newpassword', $newpassword, PDO::PARAM_STR);
      $chngpwd1->execute();

      echo '<script>alert("Your password successully changed");window.location="dashboard.php"</script>';
    } else {
  ...
  <head>
    ...
    <title>QuickCare | Change Password</title>
