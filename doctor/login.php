        ...
        <div class="container-sm">
            <div class="d-flex justify-content-center align-items-center mt-4">
                <div class="col-5 d-flex justify-content-center m-auto">
                    <div class="card mb-4 mt-4 wid text-black border w-100" style="border-radius: 20px;">
                        <div class="card-body p-4 m-0">
                            ...
                            <form name="myForm" class="font" method="POST" action="./logdoc.php">
                                <img class="d-flex justify-content-center m-auto img-fluid" width="40%" src="../assets/images/logos/quickcare.png" />
                                <h4 class="text-center mb-4 fs-2">Doctor's Login</h4>
