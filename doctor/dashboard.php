									...
									<div class="widget-body clearfix ">
										...
										<div class="pull-left">
											<h3 class="widget-title text-warning"><span class="counter"
													...
													<?php echo htmlentities($totnewapt); ?>
												</span></h3>
							...
							<div class="col-md-6 col-sm-6">
								<div class="widget stats-widget" style="border-radius:15px">
									<div class="widget-body clearfix">
										...
										$docid = $_SESSION['damsid'];
										;
										$sql = "SELECT * from  appointment where Status='Approved' && Doctor=:docid ";
										$query = $dbh->prepare($sql);
										$query->bindParam(':docid', $docid, PDO::PARAM_STR);
										$query->execute();
										$results = $query->fetchAll(PDO::FETCH_OBJ);
								...
								<div class="widget stats-widget" style="border-radius:15px">
									<div class="widget-body clearfix">
										<div class="pull-left">
											...
											$docid = $_SESSION['damsid'];
											;
											$sql = "SELECT * from appointment where Status='Cancelled' && Doctor=:docid ";
											$query = $dbh->prepare($sql);
											$query->bindParam(':docid', $docid, PDO::PARAM_STR);
											$query->execute();
											$results = $query->fetchAll(PDO::FETCH_OBJ);
								...
								<div class="widget stats-widget" style="border-radius:15px">
									<div class="widget-body clearfix">
										...
										<div class="pull-left">
											...
											$docid = $_SESSION['damsid'];
											;
											$sql = "SELECT * from appointment where Doctor=:docid ";
											$query = $dbh->prepare($sql);
											$query->bindParam(':docid', $docid, PDO::PARAM_STR);
											$query->execute();
											$results = $query->fetchAll(PDO::FETCH_OBJ);
