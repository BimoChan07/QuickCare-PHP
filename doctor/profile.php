...
if (strlen($_SESSION['damsid']==0)) {
  ...
  $sql="update doctor set fullname=:name,phone=:phone,email=:email,specialization=:sid where id=:did";
      ...
      <div class="col-md-12">
        <div class="widget">
          ...
          <div class="widget-body">
            <?php
$did=$_SESSION['damsid'];
$sql="SELECT doctor.*,specialization.ID as sid,specialization.Specialization as sssp from doctor join specialization on specialization.ID=doctor.specialization where doctor.id=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
