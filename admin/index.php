                            ...
                            <form method="POST" class="mt-2">
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <span class="text-danger">*</span></b> <input
                                            class="form-control mb-2 border-secondary" name="user" type="text" required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="password" class="form-control border-secondary mb-4"
                                                name="pass" id="password" placeholder="Password"
                                                onfocus="toggleVisibility()" aria-label=" Recipient's username"
